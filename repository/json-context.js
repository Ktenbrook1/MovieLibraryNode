...
const users = {
  findAll: () => findAll(usersPath),
  findById: (id) => findById(usersPath, id),
  create: (data) => create(usersPath, data),
  update: (data) => update(usersPath, data),
  delete: (id) => deleteRecord(usersPath, id),
};
...
module.exports = { movies: movies, users: users };
